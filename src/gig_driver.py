...
def benchmark_gig_initial_population(
    ...
    for initial_population_func in initial_population_functions:
        ...
        for i in range(NUM_OF_RUNS):
            ...
            quality = calculate_data_points(automaton=result_dfa, s_plus=s_plus, s_minus=s_minus)
        ...
        results.append((initial_population_func.__name__, average_quality, average_generations))

    headers = ["Initial Population Function", "Average Quality", "Average Generations"]
